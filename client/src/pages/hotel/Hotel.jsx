...
const Hotel = () => {
  ...
  const handleMove = (direction) => {
    ...
    if (direction === 'l'){
      newSliderNoumber = slideNumber === 0 ? (parseInt(photos.length) - 1) : slideNumber - 1;
    } else {
      newSliderNoumber = slideNumber === (parseInt(photos.length) - 1) ? 0 : slideNumber + 1;
    }
      ...
      <div className="hotel--container">
        {open && <div className="slider">
          ...
          <div className="slider--wrapper">
            <img src={photos[slideNumber].src} alt="" className="slider--image" />
          </div>
